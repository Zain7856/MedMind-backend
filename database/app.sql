...
CREATE TABLE users (
  ...
  , ApprovalStatus VARCHAR(20) NOT NULL CHECK (
...
VALUES
  (
    15
    , 'Dr. Mahmoud Hassan'
    , 'drmahmoudhassan@medmind-doc.com'
    , 'password123'
    , 40
    , '01033334444'
    , 'Doctor'
...
VALUES
  (
    ...
    , 'citygeneralhospital@medmind-hos.com'
    , 'password123'
    , NULL
    , '0233445566'
    , 'Hospital'
...
VALUES
  (
    ...
    , 'healthcaremedicalcenter@medmind-hos.com'
    , 'password123'
    , NULL
    , '0344556677'
    , 'Hospital'
...
VALUES
  (
    ...
    , 'nilevalleyhospital@medmind-hos.com'
    , 'password123'
    , NULL
    , '0223445566'
    , 'Hospital'
...
VALUES
  (
    30
    , 'Delta Care Hospital'
    , 'deltacarehospital@medmind-hos.com'
    , 'password123'
    , NULL
    , '0501122334'
    , 'Hospital'
...
VALUES
  (
    ...
    , 'aswanroyalhospital@medmind-hos.com'
    , 'password123'
    , NULL
    , '0972233445'
    , 'Hospital'
...
VALUES
  (
    33
    , 'Sinai Oasis Clinic'
    , 'sinaioasisclinic@medmind-hos.com'
    , 'password123'
    , NULL
    , '0691122334'
    , 'Hospital'
...
VALUES
  (
    ...
    , 'portsaidhopehospital@medmind-hos.com'
    , 'password123'
    , NULL
    , '0661122334'
    , 'Hospital'
...
VALUES
  (
    ...
    , 'tantaadvancedmedical@medmind-hos.com'
    , 'password123'
    , NULL
    , '0403344556'
    , 'Hospital'
...
VALUES
  (
    ...
    , 'luxorheritagehospital@medmind-hos.com'
    , 'password123'
    , NULL
    , '0952233445'
    , 'Hospital'
...
INSERT INTO
  diseases (ID, Name, description, treatment, img)
VALUES
  (
    1
    , 'Seasonal Flu'
...
INSERT INTO
  hospitals (ID, UserID, Name, Location, Phone, img, Services)
VALUES
  (
    1
    , 27
...
INSERT INTO
  symptomdiseases (SymptomID, DiseaseID)
VALUES
  (2, 1);
INSERT INTO
  symptomdiseases (SymptomID, DiseaseID)
...
VALUES
  (1, 2, NULL, 1, '2025-12-20T10:00:00', 'Pending');
INSERT INTO
  appointments (
    ID
    , UserID
...
VALUES
  (2, 2, 1, NULL, '2025-12-21T14:00:00', 'Pending');
INSERT INTO
  appointments (
    ID
    , UserID
...
VALUES
  (3, 11, NULL, 1, '2026-04-17T19:45:00', 'Pending');
INSERT INTO
  appointments (
    ID
    , UserID
...
VALUES
  (4, 11, NULL, 3, '2026-07-21T15:10:00', 'Pending');
INSERT INTO
  appointments (
    ID
    , UserID
...
VALUES
  (5, 11, NULL, 2, '2026-07-21T15:14:00', 'Pending');